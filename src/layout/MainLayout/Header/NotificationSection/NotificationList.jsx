...
import User1 from '../../../../assets/images/users/avatar BT.jpg';
    ...
    >
      <ListItemWrapper>
        <ListItem alignItems="center">
          <ListItemAvatar>
            <Avatar alt="Bien Tran" src={User1} />
          </ListItemAvatar>
          <ListItemText primary="Bien Tran" />
          <ListItemSecondaryAction>
      ...
      <ListItemWrapper>
        <ListItem alignItems="center">
          ...
          <ListItemText primary={<Typography variant="subtitle1">Bien Tran</Typography>} />
          <ListItemSecondaryAction>
            <Grid container justifyContent="flex-end">
              <Grid item xs={12}>
                <Typography variant="caption" display="block" gutterBottom>
